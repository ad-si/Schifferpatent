...
questions:
  ...
  - q: Welche Anforderungen werden an die Maschinenanlage auf Ihrem Fahrzeug hinsichtlich des Umweltschutzes gestellt?
  ...
  - q: Bei einem Schiff mit linksdrehendem Propeller (Schiffsschraube) nehmen sie Fahrt achteraus auf, nach welcher Seite wird das Schiff abdrehen?
    a: Nach Steuerbord
    c: [a, d]
    s: Allgemeines, Zulassung, Bau & Ausrüstung
  ...
  - q: Welches sind die erforderlichen Fahrtlichter von Vergnügungsfahrzeugen mit Maschinenantrieb über 4.4 kW gemäß BodenseeSchO? (Sektoren, Sichtweite, Farbe)?
  ...
  - q: Woran können Sie erkennen, dass sich ein fremdes Schiff in einer Notlage befindet und Hilfe benötigt?
  ...
  - q: Im Seerhein vor Gottlieben kommen auf Ihrem Fahrkurs talwärts bei Nacht etwas über der Wasseroberfläche zwei rote Lichter, darunter zwei weiße Lichter in Sicht. Welche Situation liegt an und wie müssen Sie sich verhalten?
  ...
  - q: Mit welchen optischen Signalen können Sie eine Notsituation auf Ihrem Fahrzeug anderen anzeigen?
  ...
  - q: Sie wollen mit Ihrem Fahrzeug den Hafen verlassen; welche Signalgebung ist gegebenenfalls erforderlich?
    a: 1 langer Ton
    c: [a, d]
    s: Schallzeichen, Lichterführung, Optische Signale
  ...
  - q: Wie viele Zentimeter auf der Seekarte entsprechen einem Kilometer bei einem Maßstab von 1:50000?
    a: 2.0 cm
    c: [a, d]
    s: Navigation & Wetterkunde
  ...
  - q: Wie haben Sie sich mit Ihrem Motorboot beim Wasserskifahren gegenüber Badenden zu verhalten?
    a: Mindestabstand 50 Meter
    c: [a, d]
    s: Ausweich & Fahrregeln
  ...
  - q: 'Kann eine Motoryacht (Höhe über Wasserlinie 3.15 m) durch den mittleren Brückenbogen der alten Rheinbrücke (Straßen- und Eisenbahn-brücke) bei Konstanz fahren? - Pegelstand: 4.50'
    a: Ja
    c: [a, d]
    s: Ausweich & Fahrregeln
  ...
  - q: Wie haben sich Vergnügungsfahrzeuge und Segelfahrzeuge beim Begegnen auf den Rheinstrecken zu verhalten, wenn genügend Raum vorhanden ist?
  ...
  - q: Sie wollen mit Ihrem Vergnügungsfahrzeug bei Nacht den Rhein queren. Es nähert sich ein Wasserfahrzeug von Backbord, welches zu seiner üblichen Lichterführung ein grünes helles Rundumlicht zeigt.
    a: Ich mit meinem Vergnügungsfahrzeug
    c: [a, d]
    s: Rheinstrecken (Alter Rhein / Seerhein)
  ...
  - q: Wie hat sich das Segelboot gegenüber dem Polizeiboot, das das blaue Blinklicht zeigt, zu verhalten?
    a: Segelboot muss Vorrecht gewähren, notfalls anhalten
    c: [d]
    s: Segeln - Fahrregeln
    img: true

  - q: Wie hat sich ein Segelboot gegenüber der Fischerboot, das einen weißen Ball gesetzt hat, zu verhalten und was ist zu beachten?
    a: Segelboot muss ausweichen, Mindestabstand 200 m
    c: [d]
    s: Segeln - Fahrregeln
    img: true

  - q: Wie hat sich ein Segelboot gegenüber einem Fischerboot, das eine weiße Flagge gesetzt hat, zu verhalten?
  ...
  # Hochrheinstrecke (Stein / Schaffhausen)
  - q: Wo verläuft die schifffahrtsrechtliche Grenze zwischen Untersee und Hochrhein?
    a: Linie oberste Steganlage Eschenz / Landestelle Öhningen
    c: [Zusatz]
    s: Hochrheinstrecke (Stein / Schaffhausen)

  - q: Mit welchen Schifffahrtszeichen wird auf dem Hochrhein die Fahrwasserseite bezeichnet?
    a: Weiß-grüne Tafeln
    c: [Zusatz]
    s: Hochrheinstrecke (Stein / Schaffhausen)

  - q: Dürfen Sie auf dem Rhein einem entgegenkommenden Schiff nach Backbord ausweichen, wenn dies nach Steuerbord nicht möglich ist?
    a: Ja, nach rechtzeitiger Abgabe des vorgeschriebenen Schallzeichens
    c: [Zusatz]
    s: Hochrheinstrecke (Stein / Schaffhausen)

  - q: Wie ist ein Fahrgastschiff im Bereich der Hemishofer Brücken zu überholen?
    a: Das Überholen ist verboten
    c: [Zusatz]
    s: Hochrheinstrecke (Stein / Schaffhausen)

  - q: Sie fahren zu Berg Richtung Diessenhofen und bemerken unterhalb der Brücke ein wendendes Kursschiff. Wie haben Sie sich zu verhalten?
    a: Wendemanöver abwarten
    c: [Zusatz]
    s: Hochrheinstrecke (Stein / Schaffhausen)

  - q: Warum soll man oberhalb der Brücke Diessenhofen möglichst in Rheinmitte fahren?
    a: Wegen zwei gegenüberliegender Badeplätze
    c: [Zusatz]
    s: Hochrheinstrecke (Stein / Schaffhausen)

  - q: Welcher Fluss mündet gegenüber Rheinklingen in den Rhein?
    a: Biber
    c: [Zusatz]
    s: Hochrheinstrecke (Stein / Schaffhausen)

  - q: Wie lang ist der für Vergnügungsschiffe zugelassene Hochrheinabschnitt?
    a: Rund 19 km
    c: [Zusatz]
    s: Hochrheinstrecke (Stein / Schaffhausen)

  - q: Sie begegnen mit Ihrem Motoboot bei der Talfahrt einem den Rhein querenden Ruderboot. Wer mus ausweichen?
    a: Das Motorboot
    c: [Zusatz]
    s: Hochrheinstrecke (Stein / Schaffhausen)

  - q: Wie ist beim Begegnen auf dem Rhein in der Regel auszuweichen?
    a: Nach Steuerbord
    c: [Zusatz]
    s: Hochrheinstrecke (Stein / Schaffhausen)

  - q: Muss sich der Führer eines Motorboots zwingend an die grün gekennzeichnete Fahrwasserseite halten?
    a: Nein, das Fahrwasserzeichen hat nur empfehlenden Charakter
    c: [Zusatz]
    s: Hochrheinstrecke (Stein / Schaffhausen)

  - q: Wie heißt die Untiefe vor Rheinklingen nach dem Schifffahrtszeichen Nr. 52?
    a: Fahrkopf
    c: [Zusatz]
    s: Hochrheinstrecke (Stein / Schaffhausen)

  - q: Liegt das Strandbad Gailingen oberhalb oder unterhalb der Brücke und auf welcher Rheinseite?
    a: Oberhalb, rechtsrheinisch
    c: [Zusatz]
    s: Hochrheinstrecke (Stein / Schaffhausen)

  - q: Wie verläuft der Rhein im Bereich der Ortschaft
    a: Starke Linkskrümmung
    c: [Zusatz]
    s: Hochrheinstrecke (Stein / Schaffhausen)

  - q: Durch welche Öffnung der Hemishofer Eisenbahnbrücke führt die gekennzeichnete Fahrrinne?
    a: Zweite Öffnung von links
    c: [Zusatz]
    s: Hochrheinstrecke (Stein / Schaffhausen)

  - q: Was müssen Sie beim Befahren der Hochrheinstrecke von ihrem Schiff speziell kennen?
    a: Den maximalen Tiefgang des Schiffes
    c: [Zusatz]
    s: Hochrheinstrecke (Stein / Schaffhausen)

  - q: Wie wird die Geschwindigkelt auf dem Hochrhein gemessen?
    a: Jeweils zum Ufer (Fahrt über Grund)
    c: [Zusatz]
    s: Hochrheinstrecke (Stein / Schaffhausen)

  - q: Bei einer Engstelle ist das gefahrlose Begegnen mit einem anderen gleichrangigen Schiff nicht möglich. Wer hat sich wie zu verhalten?
    a: Das zu Berg fahrende Schiff muss unterhalb der Engstelle die Durchfahrt des Talfahrers abwarten
    c: [Zusatz]
    s: Hochrheinstrecke (Stein / Schaffhausen)

  - q: Wie begegnen Sie Fahrzeugen. die in der Fahrrinne treiben?
    a: Mit genügend Abstand und möglichst geringem Wellenschlag
    c: [Zusatz]
    s: Hochrheinstrecke (Stein / Schaffhausen)

  - q: Wo ist das Ankern auf dem Rhein grundsätzlich verboten?
    a: Im Bereich von Brücken und offiziellen Landestellen sowie in Fahrrinnen und Fahrwasserengen
    c: [Zusatz]
    s: Hochrheinstrecke (Stein / Schaffhausen)

  - q: Dürfen Sie zollpflichtige Waren aus der Schweiz ohne weitere Formalitäten nach Deutschland einführen?
    a: Nein, die Waren müssen bei einem deutschen Zellamt angemeldet werden
    c: [Zusatz]
    s: Hochrheinstrecke (Stein / Schaffhausen)

  - q: Wie legen Kursschiffe in Diessenhofen an?
    a: Gegen die Strömung
    c: [Zusatz]
    s: Hochrheinstrecke (Stein / Schaffhausen)

  - q: Sie befahren den Hochrhein mit ihrem Vergnügungsfahraeug zu Tal, mit Ziel Schaffhausen. Wo endet für Sie die Schifffahrt?
    a: Unmittelbar vor der Eisenbahnbrücke Schaffhausen—Feuerthalen
    c: [Zusatz]
    s: Hochrheinstrecke (Stein / Schaffhausen)

  - q: Wie viele Brücken dürfen Sie mit Ihrem Vergnügungsfahrzeug auf der Hochrheinstrecke passieren?
    a: 4 Brücken
    c: [Zusatz]
    s: Hochrheinstrecke (Stein / Schaffhausen)

  - q: Darf ein langsamer fahrendes Schiff auf dem Rhein überholt werden?
    a: Ja, beidseitig, mit genügend Abstand, wenn dadurch der zu Überholende nicht behindert wird
    c: [Zusatz]
    s: Hochrheinstrecke (Stein / Schaffhausen)

  - q: Wer hat beim Zusammentreffen im Bereich von Brücken immer, unabhängig von Berg- und Talfahrt, das Wegerecht?
    a: Vorrangschiffe
    c: [Zusatz]
    s: Hochrheinstrecke (Stein / Schaffhausen)

  - q: Wie haben Sie sich gegenüber Fischern, Schwimmern und Ruderbooten zu verhalten?
    a: Ich halte den größtmöglichen Abstand und reduziere die Geschwindigkeit so, dass kein oder nur noch geringer Wellenschlag entsteht
    c: [Zusatz]
    s: Hochrheinstrecke (Stein / Schaffhausen)

  - q: Wo liegt die Untiefe Wellenstein?
    a: Zwischen Bibermühle und Schupfen
    c: [Zusatz]
    s: Hochrheinstrecke (Stein / Schaffhausen)

  - q: Befindet sich die Schiffslandestelle Büsingen oben oder unterhalb der starken Flusskrümmung im Bereich der Ortschaft?
    a: Oberhalb
    c: [Zusatz]
    s: Hochrheinstrecke (Stein / Schaffhausen)

  - q: Wie heißen die deutschen Ortschaften am Hochrhein?
    a: Gailingen, Büsingen
    c: [Zusatz]
    s: Hochrheinstrecke (Stein / Schaffhausen)

  - q: Nennen Sie die linksrheinisehe Schiffslandestelle, die von den Fahrgastschiffen angelaufen wird?
    a: Diessenhofen
    c: [Zusatz]
    s: Hochrheinstrecke (Stein / Schaffhausen)

  - q: Welche Höchstgeschwindigkeit darf auf der Hochrheinstrecke gefahren werden?
    a: 20 km/h auf der Talfahrt, 10 km/h bei der Bergfahrt
    c: [Zusatz]
    s: Hochrheinstrecke (Stein / Schaffhausen)

  - q: Welche Regeln bestehen auf der Hochrheinstrecke für das Wellenbrettfahren und Wasserskilaufen?
    a: Nicht erlaubt
    c: [Zusatz]
    s: Hochrheinstrecke (Stein / Schaffhausen)

  - q: Wo befindet sich die erste schweizerische Zollanlegestelle nach der Einfahrt in den Hochrhein?
    a: Rechtsrheinisch unterhalb der Straßenbrücke Stein am Rhein
    c: [Zusatz]
    s: Hochrheinstrecke (Stein / Schaffhausen)

  - q: Nennen Sie die Brücken der Hochrheinstrecke im Bereich der BodenseeSchO in Strömungsrichtung
    a: Straßenbrücke Stein am Rhein, Straßenbrücke Hemishofen, Eisenbahnbrücke Hemishofen, Straßenbrücke Diessenhofen, Eisenbahnbrücke Schaffhausen, Straßenbrücke Schaffhausen
    c: [Zusatz]
    s: Hochrheinstrecke (Stein / Schaffhausen)

  - q: An welcher Brücke auf dem Hochrhein endet die Sportschifffahrt
    a: Eisenbahnbrücke Schaffhausen
    c: [Zusatz]
    s: Hochrheinstrecke (Stein / Schaffhausen)

  - q: Nennen Sie die rechtsrheinischen Schiffslandestellen in Fließrichtung, die die Kursschiffahrt in der Saison regelmäßig anfährt?
    a: Stein am Rhein, Büsingen, Schaffhause
    c: [Zusatz]
    s: Hochrheinstrecke (Stein / Schaffhausen)

  - q: In welchem Bogen einer Krümmung beﬁndet sich der Grund?
    a: Im Innenbogen
    c: [Zusatz]
    s: Hochrheinstrecke (Stein / Schaffhausen)

  - q: In welchem Bogen einer Krümmung beﬁndet sich der Hang?
    a: Im Außenbogen
    c: [Zusatz]
    s: Hochrheinstrecke (Stein / Schaffhausen)

  - q: Welche Fahrwasserverhältnisse konnen Sie im Innenbogen einer Flusskrümmung annehmen?
    a: Flachwasser, Untiefen
    c: [Zusatz]
    s: Hochrheinstrecke (Stein / Schaffhausen)

  - q: Wie viele Öffnungen besitzt die Hemisbofener Eisenbahnbrücke im Bereich des Flussbettes?
    a: 4
    c: [Zusatz]
    s: Hochrheinstrecke (Stein / Schaffhausen)

  - q: An welchem Ufer der Hochrheinbrücke mündet die Biber und worauf ist unmittelbar unterhalb der Mündung zu achten?
    a: Rechtes Ufer, Untiefen, Felsen
    c: [Zusatz]
    s: Hochrheinstrecke (Stein / Schaffhausen)

  - q: Welche Fahrwasserverhältnisse können Sie in der Regel im Außenbogen einer Flusskrümmung annehmen?
    a: Ausreichende Wassertiefe
    c: [Zusatz]
    s: Hochrheinstrecke (Stein / Schaffhausen)

  - q: Wo befinden sich kurz unterhalb der Bibermühle Untiefen (Felsen) im Gewässerbett in Fahrtrichtung Stein am Rhein nach Schaffhausen?
    a: Linksrheinisch
    c: [Zusatz]
    s: Hochrheinstrecke (Stein / Schaffhausen)
---
...
Lies zuerst [Wer benötigt das Schifferpatent?](
/schifferpatent#wer-ben-tigt-das-schifferpatent-)
für eine Erklärung der Kategorien.

Das Patent für die Hochrheinstrecke ist kein Teil des Bodenseeschifferpatents A
und muss durch eine zusätzliche kostepflichtige Prüfung erworben werden.

Prüfungsverfahren:

- 1 von 3 Antworten ist richtig (hier sind nur richtige Antworten aufgelistet)
- Jedes Prüfungsgebiet hat eine Mindestpunktzahl.
  Bei nicht erreichen muss die gesamte Prüfung wiederholt werden.
  Frühestens nach 4 Wochen, spätestens nach 12 Monaten.
- 60 Minuten für allgemeinen Teil
- 20 Minuten für Segelfragen
